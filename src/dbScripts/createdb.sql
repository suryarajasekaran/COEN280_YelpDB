...
CREATE INDEX USER_BID ON USERS (USERID);
CREATE INDEX BUSINESS_BID ON BUSINESS (BID);
CREATE INDEX BUSINESS_OP_CL ON BUSINESS (OP_CL);
CREATE INDEX REVIEWS_USERID ON REVIEWS (USERID);
CREATE INDEX REVIEWS_RID ON REVIEWS (RID);
